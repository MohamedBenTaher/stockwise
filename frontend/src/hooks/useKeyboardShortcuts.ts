...
export function useCommandPalette() {
  ...
  const commands = [
    ...
    { id: 'nav-holdings', label: 'Go to Holdings', action: () => navigate('/dashboard/holdings') },
    { id: 'nav-insights', label: 'Go to Insights', action: () => navigate('/dashboard/insights') },
    { id: 'nav-risk', label: 'Go to Risk Analysis', action: () => navigate('/dashboard/risk') },
    { id: 'nav-charts', label: 'Go to Charts', action: () => navigate('/dashboard/charts') },
    { id: 'nav-news', label: 'Go to News', action: () => navigate('/dashboard/news') },
    
    // Action commands
    { id: 'add-holding', label: 'Add New Holding', action: () => navigate('/dashboard/holdings/add') },
    { id: 'refresh', label: 'Refresh Page', action: () => window.location.reload() },
    
    // Quick actions
    { id: 'clear-cache', label: 'Clear Cache', action: () => {
      localStorage.clear();
