      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Join thousands of investors who use StockWise to make data-driven
            decisions, reduce risk, and optimize their portfolios with
            AI-powered insights.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <Link to="/demo">
            <Button
              variant="outline"
              className="px-[30px] py-2 border-border text-foreground hover:bg-accent text-base font-medium leading-6 rounded-[99px] bg-transparent transition-all duration-200"
              size="lg"
            >
              Watch Demo
            </Button>
